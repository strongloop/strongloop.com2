...
I recently had a conversation with a follower on Twitter about how [Vue.js](https://vuejs.org/) and LoopBack could work together. Because of how LoopBack works, this is almost a non-issue. By creating a simple REST-based API, there's nothing "special" about using Vue.js with LoopBack, just as there wouldn't be anything special if you used React or Angular. That being said, I still thought it would be nice to give a quick demonstration on how a Vue.js application could be built with LoopBack as the back end.
