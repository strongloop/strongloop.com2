...
If a post's title date is in the future, it won't show up in the list of latest blogs on
the main blog page or in the blog archive page of all blog posts.
...
- `date`: Publication date of your post in `yyyy-mm-dd` format. NOTE Please mark date as several days / weeks ahead until publication date is finalized.
