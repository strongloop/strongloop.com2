...
Also **DO** use custom error classes like `BadRequestError` as it makes sorting errors out easier. You can learn more in courses that include [details on learning Javascript](https://generalassemb.ly/coding/full-stack-web-development):
